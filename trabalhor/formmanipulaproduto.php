		...
		<?php
			...
			if (mysqli_num_rows($result) > 0) {
				while($vet = mysqli_fetch_array($result)){
					...
					echo "<tr>";
					echo "<td>$codigo</td><td>$nome</td><td>$preco</td><td>$estoque</td><td>$validade</td>";
					echo "<td><form action='formalteraproduto.php' method='POST'><input type='submit' value='Alterar'>";
					echo "<input type='hidden' name='codigo' value='$codigo'></form></td>";
					echo "<td><form action='excluiproduto.php' method='POST'><input type='submit' value='Excluir'>";
					echo "<input type='hidden' name='codigo' value='$codigo'></form></td>";
					echo "</tr>";
				}
			}
